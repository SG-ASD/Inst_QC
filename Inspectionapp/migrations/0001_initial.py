    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Appearance_Shock_Watch_Image', models.ImageField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.test_path)),
                ('Appearance_Binding_Image', models.ImageField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.Appearance_image_path)),
                ('Appearance_Labels_Image', models.ImageField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.Appearance_image_path)),
                ('Appearance_Packaging_Box_Image', models.ImageField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.Appearance_image_path)),
                ('Appearance_Wooden_Pallet_Image', models.ImageField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.Appearance_image_path)),
                ('Appearance_Transport_Jig_Image', models.ImageField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.Appearance_image_path)),
                ('Appearance_Video', models.FileField(blank=True, null=True, upload_to=Inspectionapp.models.Inspection.Appearance_image_path)),
